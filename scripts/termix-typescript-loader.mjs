...
const EXACT_ENTRYPOINTS = new Set([
  ...
  resolvePath(REPOSITORY_ROOT, "scripts/compile-termix-protected-final-evidence.ts"),
  resolvePath(REPOSITORY_ROOT, "scripts/materialize-termix-independent-review.ts"),
