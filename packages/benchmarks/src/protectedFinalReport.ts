...
export const TERMIX_FINAL_TASK_IDS = TERMIX_REVIEW_TASK_IDS;
...
export const TermixFinalSourceSchema = z
  .strictObject({
    ...
    adjudication: TermixProtectedIndependentAdjudicationSchema
  })
  ...
  adjudications: z
    .array(
      z.strictObject({
        ...
        reviewer: TermixProtectedIndependentAdjudicationSchema.shape.reviewer,
        checks: TermixProtectedIndependentAdjudicationSchema.shape.checks,
        evidence: TermixProtectedIndependentAdjudicationSchema.shape.evidence,
        limitations: TermixProtectedIndependentAdjudicationSchema.shape.limitations
      })
    )
    .length(3)
});
