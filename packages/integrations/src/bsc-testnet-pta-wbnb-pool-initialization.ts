...
export const BSC_TESTNET_PTA_WBNB_POOL_ENVELOPE_LIFETIME_SECONDS = 300 as const;
export const BSC_TESTNET_PTA_WBNB_POOL_OWNER_CONFIRMATION_WINDOW_SECONDS = 240 as const;
export const BSC_TESTNET_PTA_WBNB_POOL_EXECUTION_AUTHORITY_LIFETIME_SECONDS = 60 as const;
export const BSC_TESTNET_PTA_WBNB_POOL_MINIMUM_REMAINING_BEFORE_CLAIM_SECONDS = 50 as const;
export const BSC_TESTNET_PTA_WBNB_POOL_MAXIMUM_POST_CONFIRMATION_PRECLAIM_SECONDS = 10 as const;
