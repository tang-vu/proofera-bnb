...
const PREDECESSOR_RECORDED_AT = "2026-08-13T07:59:58.000Z";
...
function predecessorTerminal() {
  return Object.freeze({
    ...
    recordedAt: PREDECESSOR_RECORDED_AT
  });
}
...
function policyBody(release = releaseIdentity()): PolicyBody {
  ...
  return Object.freeze({
    ...
    kind: "owner_designated_internal_multi_agent_release_review_policy_generation_9_v9" as const,
    decision: "GO_EXACT_CHAIN_97_RECOVERY_GENERATION_9_POLICY" as const,
    ...
    caps: Object.freeze({
      ...
      maximumGasEstimate: "5500000" as const,
      maximumGasLimit: "6600000" as const,
      ...
      maximumExecutionAuthorityLifetimeSeconds: "120" as const,
      minimumRemainingBeforeClaimSeconds: "60" as const,
    ...
    scope: Object.freeze({
      ...
      predecessorSubmissionV7JournalStateRequired: "exact_empty" as const,
      predecessorStateRequired: "failed_before_worker" as const,
      predecessorIssueCodeRequired: "GAS_POLICY_VIOLATION" as const,
      ...
      freshEnvelopeAfterTerminalRequired: true as const
    }),
...
describe("BSC testnet PTA/WBNB release-review policy", () => {
  it("binds one full release and exact no-LP chain-97 policy without claiming envelope inspection", () => {
    ...
    expect(admission.policy).toMatchObject({
      schemaVersion: 9,
      decision: "GO_EXACT_CHAIN_97_RECOVERY_GENERATION_9_POLICY",
      operationKey: BSC_TESTNET_PTA_WBNB_POOL_OPERATION_KEY,
      ...
      scope: {
        ...
        predecessorSubmissionV7JournalStateRequired: "exact_empty",
        predecessorStateRequired: "failed_before_worker",
        predecessorIssueCodeRequired: "GAS_POLICY_VIOLATION",
  ...
  it("requires exact terminal ordering and a distinct later execution envelope", () => {
    const {
    ...
    const cases = [
      instantiationInput(BSC_TESTNET_PTA_WBNB_POOL_GENERATION_8_ENVELOPE_HASH),
      Object.freeze({
        ...instantiationInput(),
      ...
      Object.freeze({
        ...
        predecessorTerminal: Object.freeze({
          ...predecessorTerminal(),
          recordedAt: EXECUTION_ENVELOPE_OBSERVED_AT
        })
      }),
      Object.freeze({
        ...instantiationInput(),
      ...
      Object.freeze({
        ...instantiationInput(),
        predecessorTerminal: Object.freeze(fenceWithoutSubmissionJournalState)
      }),
      Object.freeze({
        ...instantiationInput(),
        predecessorTerminal: Object.freeze({
          ...predecessorTerminal(),
          predecessorTerminalRawSha256: `0x${"02".repeat(32)}`,
          unexpected: true
        })
      })
    ];
    ...
    > = [
      ...
      (binding) => {
        binding.recovery = Object.freeze({
          ...
          predecessorTerminal: Object.freeze({
            ...predecessorTerminal(),
            predecessorTerminalRawSha256: `0x${"78".repeat(32)}`
          })
        });
      },
      (binding) => {
  ...
  it("accepts the exact 65,536-byte policy boundary within the 100-KiB transport cap", () => {
    ...
    expect(maximumLineBytes).toBe(2_619);
    expect(maximumLineBytes).toBeLessThanOrEqual(2_700);
    expect(transport.byteLength).toBe(99_974);
