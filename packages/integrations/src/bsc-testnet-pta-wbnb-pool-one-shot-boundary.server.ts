...
/**
 * Legacy preparation-only receipt shape. It is non-authorizing: the executable generation-5 path
 * obtains a separately branded owner-v8 intent outside this module, and copied JSON/digests here
