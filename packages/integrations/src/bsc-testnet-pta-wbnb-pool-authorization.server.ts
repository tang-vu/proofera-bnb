...
export const BSC_TESTNET_PTA_WBNB_POOL_OWNER_AUTHORIZATION_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.owner-envelope-authorization.v6" as const;
...
> {
  ...
  readonly kind: "exact_owner_recovery_generation_6_signature_and_single_broadcast_authorization_v7";
  readonly decision: "authorize_fresh_chain_97_pool_recovery_generation_6_signature_and_single_broadcast";
...
function createBscTestnetPtaWbnbPoolAuthorizationGateCore(
  ...
  const authorize = (
    ...
    const ownerV4 =
      ownerKind ===
      "exact_owner_recovery_generation_6_signature_and_single_broadcast_authorization_v7";
    ...
    if (
      ...
      authorizedAt === null ||
      ownerExpiry === null ||
      owner.schemaVersion !== 7 ||
      owner.kind !==
        "exact_owner_recovery_generation_6_signature_and_single_broadcast_authorization_v7" ||
      owner.decision !==
        "authorize_fresh_chain_97_pool_recovery_generation_6_signature_and_single_broadcast" ||
