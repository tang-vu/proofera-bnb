...
export const BSC_TESTNET_PTA_WBNB_POOL_SUBMISSION_SCHEMA_VERSION = 7 as const;
export const BSC_TESTNET_PTA_WBNB_POOL_SUBMISSION_SCOPE =
  "authenticated_exact_pool_recovery_generation_7_submission_after_durable_signed_commit" as const;
...
const SUBMISSION_STARTED_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.submission-started.v7" as const;
const RECONCILIATION_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.reconciliation.v7" as const;
