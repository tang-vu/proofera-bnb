...
export const BSC_TESTNET_PTA_WBNB_POOL_SUBMISSION_SCHEMA_VERSION = 8 as const;
export const BSC_TESTNET_PTA_WBNB_POOL_SUBMISSION_SCOPE =
  "authenticated_exact_pool_recovery_generation_8_submission_after_durable_signed_commit" as const;
...
const SUBMISSION_STARTED_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.submission-started.v8" as const;
const RECONCILIATION_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.reconciliation.v8" as const;
...
function snapshotRecoveryAttempt(
  ...
  if (
    ...
    !exactBytes32(recovery.predecessorTerminalRawSha256) ||
    recovery.predecessorTerminalRawSha256 === ZERO_WORD ||
