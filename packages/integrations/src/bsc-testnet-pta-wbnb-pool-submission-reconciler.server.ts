...
export const BSC_TESTNET_PTA_WBNB_POOL_SUBMISSION_SCHEMA_VERSION = 9 as const;
export const BSC_TESTNET_PTA_WBNB_POOL_SUBMISSION_SCOPE =
  "authenticated_exact_pool_recovery_generation_9_submission_after_durable_signed_commit" as const;
...
const SUBMISSION_STARTED_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.submission-started.v9" as const;
const RECONCILIATION_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.reconciliation.v9" as const;
