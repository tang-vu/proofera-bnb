...
import {
  ...
  type BscTestnetPtaWbnbPoolDurableOwnerV5Policy,
...
const TERMINAL_PREFLIGHT_DIGEST_DOMAIN =
  "proofera.bsc-testnet.pta-wbnb-pool.terminal-pre-send.v4" as const;
...
function exactOwnerPolicy(value: unknown): value is BscTestnetPtaWbnbPoolDurableOwnerV5Policy {
  return sameJson(value, BSC_TESTNET_PTA_WBNB_POOL_DURABLE_OWNER_V5_POLICY);
}
