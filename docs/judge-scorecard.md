...
| Production credibility             | Durable custom-domain deployment, PM2 supervision, evidence carrier with an exact-build 11-check host-origin probe, proof room, six-scene rehearsal, and base-release exact-path rollback/restoration evidence | Retain independent uptime/paging evidence; record and clean-room-check the final demo                            | Before recording        |
