...
| Production credibility             | Durable custom-domain deployment, PM2 supervision, frozen base rollback/restoration, current build `dcd1de0` two-resolver/five-TLS-host/11-response rehearsal plus hosted monitor run `34093342689`, product ancestor `f25a67d` richer 4/4 journey capture, and a decoded 325.014-second MiMo demo published at [YouTube](https://youtu.be/ron927GeVXI) with scoped owner audio/visual acceptance | Keep owner review distinct from independent uptime/paging evidence                                                                                                                 | During judging          |
...
| Marketplace quality — 20%        | Public four-category UI, verified identity/hire layers, one-grant control model, proof room and retained zero-instruction analysis-service journey | Capital-bearing hire and independent clean-room review remain unavailable |
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Public product     | Build `dcd1de0` retains DNS 5/5, TLS 5/5 and HTTP 11/11 plus hosted monitor run `34093342689`; ancestor `f25a67d` retains 4 available evidence panels plus 4 completed runs | Independent paging remains unavailable                                                 |
