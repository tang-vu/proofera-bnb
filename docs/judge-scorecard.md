...
| Production credibility             | Durable custom-domain deployment, PM2 supervision, current exact-build 11-check host-origin probe, proof room, six-scene rehearsal, and current-release exact-path rollback/restoration evidence    | Deploy and probe the evidence carrier; retain independent uptime/paging evidence                                 | Before recording        |
