...
| Production credibility             | Durable custom-domain deployment, PM2 supervision, frozen base rollback/restoration, current carrier `1282910` two-resolver/five-TLS-host/11-response rehearsal, product ancestor `f25a67d` richer 4/4 journey capture, and a decoded 297.080-second narrated demo                                                        | Retain independent uptime/paging evidence and owner-confirmed separate-viewer playback                                                                                             | Before submission       |
