...
Updated: 2026-09-04. This is an internal pre-submission control sheet derived from the official Smart Money Era page review recorded in [`research.md`](./research.md), the bounded [submission audit](../evidence/submission/hackathon-submission-audit-2026-09-01.json) and the current [score strategy](./hackathon-score-strategy.md). It is not a judging result, partner endorsement, eligibility decision, or submission receipt. Every “current proof” item must remain independently inspectable; every open item blocks the corresponding claim.
...
| Production credibility             | Durable custom-domain deployment, PM2 supervision, frozen base rollback/restoration, current carrier `1282910` two-resolver/five-TLS-host/11-response rehearsal, product ancestor `f25a67d` richer 4/4 journey capture, and a decoded 325.014-second MiMo demo                                                            | Retain independent uptime/paging evidence and owner-confirmed separate-viewer playback                                                                                             | Before submission       |
...
| Demo               | Six-scene 325.014-second MiMo MP4 plus separate-process copy/hash/full-decode/public-scene check                                        | Owner-confirmed narration/presentation playback                                        |
