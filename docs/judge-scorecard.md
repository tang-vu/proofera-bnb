...
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| End-to-end journey                 | Landing, marketplace, four registered dossiers, direct Studio handoff and public A2A analysis activation, one-grant Session Control, historical Mission Control, `/proof`, and one controlled chain-97 LP position are implemented                                     | Exact public `land → find → understand → activate analysis → inspect` capture is retained for 4/4 categories; keep capital execution and testnet eligibility separate | 0:00–4:05               |
...
| Production credibility             | Durable custom-domain deployment, PM2 supervision, frozen base rollback/restoration, retained `9f32dda` two-resolver/five-TLS-host/11-response observation, current `a09e70f` exact release probe plus 4/4 journey capture, and a decoded 297.080-second narrated demo | Retain independent uptime/paging evidence and owner-confirmed separate-viewer playback                                                                                | Before submission       |
...
| ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Public product     | `a09e70f` live on `proofera.tangvu.dev`; exact release probe and 4/4 public analysis journey retained; earlier two-resolver/TLS observation preserved | Independent uptime/paging remains unavailable                                          |
