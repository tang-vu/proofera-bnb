...
| ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- |
| End-to-end journey                 | Landing, mandate-selected live evidence, four registered dossiers, direct Studio handoff and public A2A analysis activation with run ID/time, one-grant Session Control, historical Mission Control, `/proof`, and one controlled chain-97 LP position are implemented                                                    | Recapture the exact public `land → find → inspect current evidence → activate analysis → inspect run` journey for 4/4 categories; keep capital execution and testnet eligibility separate | 0:00–4:05               |
| Decision-useful live data          | The marketplace directly reads five bounded category facts from the controlled Pancake testnet position for LP/Grid, the official Lista mainnet API for Yield, or an unrelated public Venus testnet replay for Health; block/retrieval time, methodology, freshness and unknowns remain visible, with no fixture fallback | Retain a public-release capture and keep raw state separate from recommendation, performance, execution authority and receipt-linked outcome/cost evidence                                | 0:35–1:25 and 2:30–3:30 |
...
| Production credibility             | Durable custom-domain deployment, PM2 supervision, frozen base rollback/restoration, public carrier `6c86226` two-resolver/five-TLS-host/11-response rehearsal, code-release `a09e70f` 4/4 journey capture, and a decoded 297.080-second narrated demo                                                                    | Retain independent uptime/paging evidence and owner-confirmed separate-viewer playback                                                                                                    | Before submission       |
...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Public product     | Carrier `6c86226` live on `proofera.tangvu.dev` with two-resolver/TLS/11-response rehearsal; ancestor `a09e70f` retains the 4/4 public analysis journey | Independent uptime/paging remains unavailable                                          |
