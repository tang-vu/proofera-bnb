...
| General engineering  | Strict TypeScript, deterministic tests, secrets scan, architecture diagram, evidence manifests, MIT license, public source/raw demo, frozen base release, current-build probe, narrated final demo, scoped owner audio/visual review, nine-job hosted CI run `33489679675`, and current-carrier hosted 11-surface uptime run `33533498008` | Clean, inspectable, security-aware implementation                                                | Entry response, dependency/SBOM review, recurring uptime history and independent paging remain open                         |
...
1. Fill the owner-only fields, place product/evidence/Altana wallet links in Additional Notes,
   submit the official CMS-linked form, request a response copy and retain it.
2. Keep the retained owner audio/visual acceptance separate from independent review.
