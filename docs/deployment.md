...
This runbook deliberately supplies placeholders rather than a current v2 audited triplet, matching v2 canonical policy, or owner TTY confirmation. The historical v1 values above are non-authorizing. It records no signature, send, receipt, pool, or liquidity.
