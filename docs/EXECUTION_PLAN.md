...
The Windows release topology now fails closed without an immutable build identifier. Its release probe binds the public health response to the exact published commit and requires readiness to be honestly `not_ready`, never `misconfigured`; a PM2 monitor repeats the same marketplace/agent/Card/readiness checks every five minutes. The public `/proof` route renders the exact build, four endpoint skill contracts and the committed seven-gate submission ledger, including blockers and digest-bound artifacts. Commit `e6e55c161f324f03b401b1e9f0a17f5fbff2d373` is publicly deployed and frozen. Its final host-origin probe retains two-resolver agreement, five authorized TLS hosts and eleven exact HTTP observations at SHA-256 `682fecefd8dd444fb52dfef5dbdc054b274f1416dbbd31666dae4b1a51c7c133`; `pancakeBenefitClaimVerified` remains false. A bounded rollback of web and monitor to `c476b01b5eb01d9595232e90cca40dece564e91a` and restoration to the frozen release both passed all eleven public checkpoints without restarting the Altana worker. External alert delivery, independent uptime evidence, deployed data/worker probes, final demo, authoritative submission receipt and a genuinely ready activation path remain open.
