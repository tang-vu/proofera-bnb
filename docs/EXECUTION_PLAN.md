...
| 2026-09-07 | Bind the current judge-facing release and hosted monitor target                               | Build `0ff8af6` passed two-resolver agreement, five authorized TLS hosts and eleven exact HTTPS checks with submitted-entry and capital-boundary markers. The hosted workflow reads a validated exact-build repository variable without receiving write or transaction authority                        |
